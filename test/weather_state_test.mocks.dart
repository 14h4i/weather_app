...
// in weather_app/test/weather_state_test.dart.
...
class MockWeatherRepository extends _i1.Mock implements _i3.WeatherRepository {
  ...
  @override
  _i4.Future<_i2.WeatherDataResponse> getWeatherByCity(String? city) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWeatherByCity,
          [city],
        ),
        returnValue: _i4.Future<_i2.WeatherDataResponse>.value(
            _FakeWeatherDataResponse_0(
          this,
          Invocation.method(
            #getWeatherByCity,
      ...
      ) as _i4.Future<_i2.WeatherDataResponse>);

  @override
  _i4.Future<_i2.WeatherDataResponse> getWeatherByPosition(
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
